...
/**
 * ThemeFeatureController_Model_Helper_HTML
 *
 * Access ThemeFeatureController_Model_Helper_HTML - internal functions
 *
 * @author Robert
 */
class ThemeFeatureController_Model_Helper_HTML {
