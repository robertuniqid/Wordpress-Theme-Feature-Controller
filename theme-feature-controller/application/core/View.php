...
class ThemeFeatureController_View {
   ...
   *
   * @return ThemeFeatureController_View
   */
  ...
  public function __construct() {
    ...
    $this->_partial_path = THEME_FEATURE_CONTROLLER_APPLICATION_PATH . $this->_partial_directory;
    $this->_layout_path = THEME_FEATURE_CONTROLLER_APPLICATION_PATH . $this->_layout_directory;
    $this->_view_path = THEME_FEATURE_CONTROLLER_APPLICATION_PATH . $this->_view_directory;
